    ...
    <div class="signup-input">
      <div class="left-input">
        ...
        <input
          ...
          onblur="this.placeholder='영문,숫자 / 10자 이내'"
        ...
        <input
          ...
          @keypress.space="checkSpace"
          onfocus="this.placeholder=''"
          onblur="this.placeholder='영문,숫자,특수기호 / 12자 이내'"
          placeholder="영문,숫자,특수기호 / 12자 이내"
        />
      ...
      <div class="right-input">
        ...
        <input
          ...
          @keypress.space="checkSpace"
          onfocus="this.placeholder=''"
          onblur="this.placeholder='10자 이내'"
          placeholder="10자 이내"
        />
        <label for="#">성별</label>
        <div class="radio-btn">
  ...
  methods: {
    ...
    signup: function () {
      ...
      if (nullCheck && pwCheck) {
        axios.post(`${SERVER_URL}/accounts/signup`, this.params).then((res) => {
          console.log(res);
